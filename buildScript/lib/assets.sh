...
curl -LSsO https://github.com/v2fly/v2ray-core/releases/download/$VERSION_V2RAY/v2ray-extra.zip
...
curl -LSsO https://github.com/v2fly/geoip/releases/download/$VERSION_GEOIP/geoip.dat
xz geoip.dat
...
curl -LSs -o geosite.dat.xz https://github.com/v2fly/domain-list-community/releases/download/$VERSION_GEOSITE/dlc.dat.xz
